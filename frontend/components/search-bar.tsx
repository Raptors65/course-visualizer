...
export default function SearchBar({
  ...
  return (
    <div className="absolute top-0 left-0 ml-5 mt-5 z-10 w-[calc(100vw-2.5rem)] sm:w-96 h-fit bg-background rounded-md">
      {isLoading ? (
        <div className="border rounded-md">
          <div className="flex gap-x-2 px-3 h-10 items-center">
        ...
        <>
          <Command shouldFilter={false} className="h-fit border">
            ...
            <CommandList
              hidden={search.length === 0 || selectedCourse !== null}
            >
